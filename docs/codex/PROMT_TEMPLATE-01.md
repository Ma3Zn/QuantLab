...
1) Read `docs/codex/BACKLOG-03.md` and `docs/codex/SESSION_PLAYBOOK.md`.
...
5) Consinstently update `docs/codex/TASKBOARD-03.md` and produce a PR summary that includes:
